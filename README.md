...
<div align="center">
  <img src="Screenshots/ChatAgent.png" alt="CRA Assistant Chat Interface" width="800" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <p><em>GDPR Assistant - GDPR Query Interface</em></p>
</div>
...
## Populating Pinecone database 


<div align="center">
  <img src="Screenshots/CreatingPinecone.png" alt="CRA Assistant Chat Interface" width="800" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <p><em>Creating Pinecone database</em></p>
</div>

- 🚀 Established Pinecone database connection by using API key
- 🔄 The dimensions are set as 384 as I have used "all-MiniLM-L6-v2" as embedding model

<div align="center">
  <img src="Screenshots/Populating Pinecone.png" alt="CRA Assistant Chat Interface" width="800" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <p><em>Populating Pinecone database</em></p>
</div>

- 🚀 Pinecone database is populated
- 🔄 It has total 517 vectors.
- 🌐 Cosine metric is used to represent similarity

Cosine angle : when you query, the database checks which vectors are pointing in a similar direction to your query vector. This is common for text embeddings, like those generated by sentence-transformers, because vectors pointing in similar directions usually mean the texts are semantically similar.

<div align="center">
  <img src="Screenshots/Pinecone database.png" alt="CRA Assistant Chat Interface" width="800" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <p><em>Populating Pinecone database</em></p>
</div>


<div align="center">
  <img src="Screenshots/Observability.png" alt="CRA Assistant Chat Interface" width="800" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
